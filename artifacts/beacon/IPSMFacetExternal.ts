...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "psm_usdcToUSDSSwapRateLimitKey",
      "inputs": [],
      "outputs": [
        {
          "name": "key",
    ...
    {
      "type": "function",
      "name": "psm_usdsToUSDCSwapRateLimitKey",
      "inputs": [],
      "outputs": [
        {
          "name": "key",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "IPSMFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
