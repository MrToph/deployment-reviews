...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "wsteth_claimWithdrawRateLimitKey",
      "inputs": [],
      "outputs": [
        {
          "name": "key",
    ...
    {
      "type": "function",
      "name": "wsteth_depositRateLimitKey",
      "inputs": [],
      "outputs": [
        {
          "name": "key",
    ...
    {
      "type": "function",
      "name": "wsteth_requestWithdrawRateLimitKey",
      "inputs": [],
      "outputs": [
        {
          "name": "key",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "IWSTETHFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
