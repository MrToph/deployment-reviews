...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "sparkVault_getTakeRateLimitKey",
      "inputs": [
        {
          "name": "sparkVault",
          "type": "address",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "ISparkVaultFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
