...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "farm_getClaimRewardRateLimitKey",
      "inputs": [
        {
          "name": "farm",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "farm_getDepositRateLimitKey",
      "inputs": [
        {
          "name": "farm",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "farm_getWithdrawRateLimitKey",
      "inputs": [
        {
          "name": "farm",
          "type": "address",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "IFarmFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
