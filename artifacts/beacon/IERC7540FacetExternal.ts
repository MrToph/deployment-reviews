...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "erc7540_getClaimDepositRateLimitKey",
      "inputs": [
        {
          "name": "token",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "erc7540_getClaimRedeemRateLimitKey",
      "inputs": [
        {
          "name": "token",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "erc7540_getRequestDepositRateLimitKey",
      "inputs": [
        {
          "name": "token",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "erc7540_getRequestRedeemRateLimitKey",
      "inputs": [
        {
          "name": "token",
          "type": "address",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "IERC7540FacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
