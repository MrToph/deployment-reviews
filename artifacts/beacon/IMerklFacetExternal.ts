...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "merkl_getToggleOperatorRateLimitKey",
      "inputs": [
        {
          "name": "distributor",
          "type": "address",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "IMerklFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
