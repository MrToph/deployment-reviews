...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "ethena_cooldownRateLimitKey",
      "inputs": [],
      "outputs": [
        {
          "name": "key",
    ...
    {
      "type": "function",
      "name": "ethena_removeDelegatedSigner",
      "inputs": [
        {
    ...
    {
      "type": "function",
      "name": "ethena_removeDelegatedSignerRateLimitKey",
      "inputs": [],
      "outputs": [
        {
          "name": "key",
    ...
    {
      "type": "function",
      "name": "ethena_setDelegatedSigner",
      "inputs": [
        {
          "name": "delegatedSigner",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "ethena_setDelegatedSignerRateLimitKey",
      "inputs": [],
      "outputs": [
        {
          "name": "key",
    ...
    {
      "type": "function",
      "name": "ethena_unstakeRateLimitKey",
      "inputs": [],
      "outputs": [
        {
          "name": "key",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "IEthenaFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
