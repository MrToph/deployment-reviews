...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "daiUSDS_daiToUSDSSwapRateLimitKey",
      "inputs": [],
      "outputs": [
        {
          "name": "key",
    ...
    {
      "type": "function",
      "name": "daiUSDS_usdsToDAISwapRateLimitKey",
      "inputs": [],
      "outputs": [
        {
          "name": "key",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "IDAIUSDSFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
