...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "wrapProxyETH_wrapRateLimitKey",
      "inputs": [],
      "outputs": [
        {
          "name": "key",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "IWrapProxyETHFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
