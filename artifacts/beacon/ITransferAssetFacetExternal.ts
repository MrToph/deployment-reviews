...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "transferAsset_getTransferRateLimitKey",
      "inputs": [
        {
          "name": "asset",
          "type": "address",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "ITransferAssetFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
