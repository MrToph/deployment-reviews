...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "curve_getAggregateDepositRateLimitKey",
      "inputs": [
        {
          "name": "pool",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "curve_getAggregateWithdrawRateLimitKey",
      "inputs": [
        {
          "name": "pool",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "curve_getAssetDepositRateLimitKey",
      "inputs": [
        {
          "name": "pool",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "curve_getAssetWithdrawRateLimitKey",
      "inputs": [
        {
          "name": "pool",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "curve_getSwapRateLimitKey",
      "inputs": [
        {
          "name": "pool",
          "type": "address",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "ICurveFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
