...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "layerZero_getTransferRateLimitKey",
      "inputs": [
        {
          "name": "oft",
          "type": "address",
      ...
      "outputs": [
        {
          "name": "sendParams",
          "type": "tuple",
          "internalType": "struct ILayerZeroFacet.SendParam",
          "components": [
            {
              "name": "dstEid",
              "type": "uint32",
        ...
        },
        {
          "name": "fee",
          "type": "tuple",
          "internalType": "struct ILayerZeroFacet.MessagingFee",
          "components": [
            {
              "name": "nativeFee",
              "type": "uint256",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "ILayerZeroFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
