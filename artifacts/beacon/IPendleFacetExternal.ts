...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "pendle_getRedeemRateLimitKey",
      "inputs": [
        {
          "name": "pendleMarket",
          "type": "address",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "IPendleFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
