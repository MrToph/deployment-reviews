...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "weeth_getClaimWithdrawRateLimitKey",
      "inputs": [
        {
          "name": "weethModule",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "weeth_getDepositRateLimitKey",
      "inputs": [
        {
          "name": "eeth",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "weeth_getRequestWithdrawRateLimitKey",
      "inputs": [
        {
          "name": "weethModule",
          "type": "address",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "IWEETHFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
