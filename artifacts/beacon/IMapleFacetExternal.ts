...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "maple_getCancelRedeemRateLimitKey",
      "inputs": [
        {
          "name": "mapleToken",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "maple_getRequestRedeemRateLimitKey",
      "inputs": [
        {
          "name": "mapleToken",
          "type": "address",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "IMapleFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
