...
export default {
  "abi": [
    ...
    {
      "type": "function",
      "name": "aave_getDepositRateLimitKey",
      "inputs": [
        {
          "name": "aToken",
          "type": "address",
    ...
    {
      "type": "function",
      "name": "aave_getWithdrawRateLimitKey",
      "inputs": [
        {
          "name": "aToken",
          "type": "address",
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "script/interfaces/ExternalFacetInterfaces.sol": "IAaveFacetExternal"
      },
      "evmVersion": "cancun",
      "libraries": {}
    },
